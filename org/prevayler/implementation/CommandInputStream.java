...
class CommandInputStream {
	...
	private static void out(Object obj) {
		Logger.getLogger("").logp(Level.INFO, null, null, obj.toString());
	}
	...
	public Command readCommand() throws IOException, ClassNotFoundException {
		...
		//Throws EOFException if there are no more log streams.
		...
		try {
			...
			//Some stream corruptions cause runtime exceptions!
		}
	...
	public PrevalentSystem readLastSnapshot()
